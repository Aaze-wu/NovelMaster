...
.PARAMETER Python
    指定用于构建的 Python 解释器，三种写法都支持：版本号（3.13 / 3.13.6）、
...
# （media_keys.py 只在开关打开时才 import），但显式带包更安全：winrt 的
# _winrt.pyd 与各投影子包得一起进包，冻结版才能建起 SMTC 会话。
